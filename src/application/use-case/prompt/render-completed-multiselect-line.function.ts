...
export const renderCompletedMultiselectLineFunction = (renderArguments: { isUnicodeSupported: boolean; message: string; promptStylePort: IPromptStylePortInterface; selectedLabels: ReadonlyArray<string>; themePort: IThemePortInterface }): string => {
